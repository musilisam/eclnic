...
public class Delete extends AppCompatActivity {
    ...
    public void delete_caregiver(final String caregiverusername)
    {
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
//                Toast.makeText(Delete.this, caregiverusername, Toast.LENGTH_SHORT).show();
                pDialog = new ProgressDialog(Delete.this);
                pDialog.setMessage("deleting caregiver...");
            ...
            protected String doInBackground(Void... params) {
                ...
                paramms.put("username", caregiverusername);
                String s = rh.sendPostRequest(URLs.main + "delete.php", paramms);
                return s;
            ...
            protected void onPostExecute(String s)
            {
                ...
                //new AlertDialog.Builder(Delete.this).setMessage(s).show();
                ...
                else Toast.makeText(Delete.this, "Operation failed!", Toast.LENGTH_SHORT).show();
    ...
    private void showthem(String s) {
        ...
        ListAdapter adapter = new SimpleAdapter(Delete.this, list, R.layout.caregiver_list,
